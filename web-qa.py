...
def crawl(url):
    ...
    while queue:
        ...
        with open('text/'+local_domain+'/'+ str(hash(url[8:].replace("/", "_"))) + ".txt", "w", encoding="UTF-8") as f:
        ...
        links = soup.find_all('a', href=re.compile("^"+full_url, re.I))
        ...
        for link in links:
            ...
            if href and domain in href and href not in seen:
                if debug:
